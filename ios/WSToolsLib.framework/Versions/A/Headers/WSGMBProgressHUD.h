...
@protocol WSUMBProgressHUDDelegate;


typedef NS_ENUM(NSInteger, WSUMBProgressHUDMode) {
    /** Progress is shown using an UIActivityIndicatorView. This is the default. */
    WSUMBProgressHUDModeIndeterminate,
    /** Progress is shown using a round, pie-chart like, progress view. */
    WSUMBProgressHUDModeDeterminate,
    /** Progress is shown using a horizontal progress bar */
    WSUMBProgressHUDModeDeterminateHorizontalBar,
    /** Progress is shown using a ring-shaped progress view. */
    WSUMBProgressHUDModeAnnularDeterminate,
    /** Shows a custom view */
    WSUMBProgressHUDModeCustomView,
    /** Shows only labels */
    WSUMBProgressHUDModeText
};

typedef NS_ENUM(NSInteger, WSUMBProgressHUDAnimation) {
    /** Opacity animation */
    WSUMBProgressHUDAnimationFade,
    /** Opacity + scale animation */
    WSUMBProgressHUDAnimationZoom,
    WSUMBProgressHUDAnimationZoomOut = WSUMBProgressHUDAnimationZoom,
    WSUMBProgressHUDAnimationZoomIn
};
...
@interface WSGMBProgressHUD : UIView
/**
 ...
 * @see animationType
 */
+ (MB_INSTANCETYPE)ws_showHUDAddedTo:(UIView *)view animated:(BOOL)animated;
 ...
 * @see animationType
 */
+ (BOOL)ws_hideHUDForView:(UIView *)view animated:(BOOL)animated;
 ...
 * @see animationType
 */
+ (NSUInteger)ws_hideAllHUDsForView:(UIView *)view animated:(BOOL)animated;
 ...
 * @see showAnimated:whileExecutingBlock:onQueue:completionBlock:
 */
- (void)showAnimated:(BOOL)animated whileExecutingBlock:(dispatch_block_t)block completionBlock:(WSUMBProgressHUDCompletionBlock)completion;
 ...
 */
- (void)showAnimated:(BOOL)animated whileExecutingBlock:(dispatch_block_t)block onQueue:(dispatch_queue_t)queue
     completionBlock:(WSUMBProgressHUDCompletionBlock)completion;

/**
 * A block that gets called after the HUD was completely hidden.
 */
@property (copy) WSUMBProgressHUDCompletionBlock completionBlock;
 ...
 */
@property (assign) WSUMBProgressHUDMode mode;
 ...
 */
@property (assign) WSUMBProgressHUDAnimation animationType;
 ...
 */
@property (MB_WEAK) id<WSUMBProgressHUDDelegate> delegate;
...
@protocol WSUMBProgressHUDDelegate <NSObject>
 ...
 */
- (void)hudWasHidden:(WSGMBProgressHUD *)hud;
 ...
 */
@interface WSUMBRoundProgressView : UIView
 ...
 */
@interface WSUMBBarProgressView : UIView
