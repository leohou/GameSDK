...
typedef enum {
	/** No error. */
	WSUSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	WSUSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	WSUSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	WSUSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	WSUSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	WSUSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	WSUSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	WSUSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	WSUSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	WSUSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	WSUSSKeychainErrorFailedToDecode = errSecDecode
} WSUSSKeychainErrorCode;

extern NSString *const WSUkSSKeychainErrorDomain;

/** Account name. */
extern NSString *const WSUkSSKeychainAccountKey;
 ...
 */
extern NSString *const WSUkSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const WSUkSSKeychainClassKey;

/** Item description. */
extern NSString *const WSUkSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const WSUkSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const WSUkSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const WSUkSSKeychainWhereKey;
 ...
 */
@interface WSGSSKeychain : NSObject
